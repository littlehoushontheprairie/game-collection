interface PlayingCardSuitProps {
    cardNumber: number
    size?: number
}

export default function PlayingCardSuit({ cardNumber, size = 32 }: PlayingCardSuitProps) {

    switch (Math.floor(cardNumber / 13)) {
        case 0:
            return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} color="#1C0F0D" fill="currentColor" viewBox="0 0 16 16">
        ...
        case 1:
            return <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} color="#CA2E55" fill="currentColor" viewBox="0 0 16 16">
